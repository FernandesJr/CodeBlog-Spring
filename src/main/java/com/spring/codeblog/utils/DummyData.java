...
public class DummyData {
    ...
    //@PostConstruct //Essa notação toda vez que a App for bildada irá execultar a percistência têm que deixar comentada
    public void savePosts(){

        List<Post> postList = new ArrayList<>();
        Post post1 = new Post();
        post1.setAutor("Fernandes Júnior");
        ...
        for(Post post: postList){
            ...
            System.out.println("ID do post: " + postSaved.getId());
        }
    }
}